...
if (!isset($_SESSION["userType"])) {
  ...
  if ($userType == "co-ordinator" || $userType == "chairman" || $userType == "provost") {
    //code goes there;
  } else {
    session_destroy();
    session_unset();
			...
			<div style=" align-content: center;" class = "std-header-info">
				...
				<br><br>
				 <div class="table-responsive">
				 	<table class="table table-bordered" style="background-color:#89CFF0">
				 		<thead>
				 			<tr>
					 			<th>Course Code</th>
					 			<th>Course Title</th>
				 ...
				 <div>
					 <table style="font-size: 10px;" class="table table-bordered" id="table" style="background-color:#43bfe1">
					 	<tr class="borderless">
				...
				<table width="100%">
					...
					<tr>
						<td width="30%">Director/ Chairman : </td>
						<td width="30%">
							<?php
								if($chDiSig == ""){
