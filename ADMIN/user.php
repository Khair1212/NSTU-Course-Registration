...
<body>
  ...
  <!-- <div class="wrapper ">
    ...
    <div class="form-inner form-style-5">
  ...
  <!-- <option value="chairman" name="Chairman">Director/Chairman</option>
        ...
        <div class="field">
          <input class="" type="text" placeholder="Email Address" name="email" required>
        </div>
  ...
  <div  class="form-style-5">
    ...
    <form method="post" action="" enctype="multipart/form-data">
      <div>
          ...
          <h6 style=" padding-top:5%;"><span class="number">NCR</span>Signup Form</h6>
          </div>
          <fieldset>
          <select name="usertype" class="form-control-lg">
        ...
        <script>
          ...
          <input class="col" type="text" placeholder="Email Address" name="email" required>



          <input class="form-control" style="margin:auto; width:50%;" type="password" placeholder="Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
          <br>
          <input class="form-control" style="margin:auto;  width:50%;" type="password" placeholder="Confirm password" name="cpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
          <br>
          <input  type="submit" value="Sign Up">
      </div>
