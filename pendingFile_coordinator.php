...
if (isset($_POST['approve_all'])) {
  ...
  if ($userType == "co-ordinator") {
    $sql = "UPDATE student_details SET  co_c_approve_stat = 1 , co_c_approve_by = '$approveId' WHERE co_c_approve_stat = 0 AND ch_di_approve_stat = 0 AND prov_approve_stat = 0";
  } else if ($userType == "chairman") {
    $sql = "UPDATE student_details SET  ch_di_approve_stat = 1 , ch_di_approve_by = '$approveId' WHERE co_c_approve_stat = 0 AND ch_di_approve_stat = 0 AND prov_approve_stat = 0";
  }
      ...
      <div class="col-md-10 mx-auto">
        <div class="filter">
          <div class="jumbotron p-1 text-center ">
            ...
            if ($year_id == 0) {
            ?>
              <a name="" id="" class="btn btn-primary topic-btn" disabled href="pendingFile_coordinator.php?year_id=0" role="button">All</a>
            <?php
            } else {
            ?>
              <a name="" id="" class="btn btn-primary" href="pendingFile_coordinator.php?year_id=0" role="button">All</a>
            ...
            ?>
              ...
              ?>
                ...
                <a name="" id="" class="btn btn-primary topic-btn m-1" href="pendingFile_coordinator.php?year_id=<?php echo $i ?>" role="button"><?php echo "Year $i" ?></a>

              <?php
              } else {
              ?>
                <a name="" id="" class="btn btn-primary m-1" href="pendingFile_coordinator.php?year_id=<?php echo $i ?>" role="button"><?php echo "Year $i" ?></a>
            <?php
              }
            }
            ?>
