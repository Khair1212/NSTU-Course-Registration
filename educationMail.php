...
<fieldset>
<legend><span class="number">NCR</span>Send Notice to Department</legend>
...
<br><br>
  ...
  <div class="container">
    ...
    <div class="card-body">
      <h2 style="color: white;"><strong>Messages from Department(s)</strong></h2>
      <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="deleteEduMail.php?d=<?= $data['too']; ?>" class="btn btn-primary"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
      </tr>
    <?php } ?>
    </tbody>
  </table>
